...
public class Convert
{
    ...
    public void Emit()
    {
        ...
        foreach (var native in api.nativeStructures)
        {
            ...
            file.WriteLine(VersionInfo.AutoGeneratedDocComment);
            file.WriteLine("namespace GDExtension;");
            file.WriteLine($"[System.CodeDom.Compiler.GeneratedCode(\"{VersionInfo.ToolName}\", \"{VersionInfo.Version}\")]");
        ...
        foreach (var f in api.untilityFunction)
        {
            ...
            if (files.TryGetValue(cat, out var file) == false)
            {
                ...
                files.Add(cat, file);
                file.Item1.WriteLine(VersionInfo.AutoGeneratedDocComment);
                file.Item1.WriteLine("namespace GDExtension;");
                file.Item1.WriteLine($"[System.CodeDom.Compiler.GeneratedCode(\"{VersionInfo.ToolName}\", \"{VersionInfo.Version}\")]");
